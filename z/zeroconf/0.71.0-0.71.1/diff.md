# Comparing `tmp/zeroconf-0.71.0.tar.gz` & `tmp/zeroconf-0.71.1.tar.gz`
...
## Comparing `zeroconf-0.71.0.tar` & `zeroconf-0.71.1.tar`
...
### Comparing `zeroconf-0.71.0/CHANGELOG.md` & `zeroconf-0.71.1/CHANGELOG.md`
...
### Comparing `zeroconf-0.71.0/COPYING` & `zeroconf-0.71.1/COPYING`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/README.rst` & `zeroconf-0.71.1/README.rst`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/build_ext.py` & `zeroconf-0.71.1/build_ext.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/docs/Makefile` & `zeroconf-0.71.1/docs/Makefile`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/docs/conf.py` & `zeroconf-0.71.1/docs/conf.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/docs/index.rst` & `zeroconf-0.71.1/docs/index.rst`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/pyproject.toml` & `zeroconf-0.71.1/pyproject.toml`
...
### Comparing `zeroconf-0.71.0/src/zeroconf/__init__.py` & `zeroconf-0.71.1/src/zeroconf/__init__.py`
...
### Comparing `zeroconf-0.71.0/src/zeroconf/_cache.pxd` & `zeroconf-0.71.1/src/zeroconf/_cache.pxd`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_cache.py` & `zeroconf-0.71.1/src/zeroconf/_cache.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_core.py` & `zeroconf-0.71.1/src/zeroconf/_core.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_dns.pxd` & `zeroconf-0.71.1/src/zeroconf/_dns.pxd`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_dns.py` & `zeroconf-0.71.1/src/zeroconf/_dns.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_exceptions.py` & `zeroconf-0.71.1/src/zeroconf/_exceptions.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_handlers.py` & `zeroconf-0.71.1/src/zeroconf/_handlers.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_history.py` & `zeroconf-0.71.1/src/zeroconf/_history.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_logger.py` & `zeroconf-0.71.1/src/zeroconf/_logger.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_protocol/__init__.py` & `zeroconf-0.71.1/src/zeroconf/_protocol/__init__.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_protocol/incoming.pxd` & `zeroconf-0.71.1/src/zeroconf/_protocol/incoming.pxd`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_protocol/incoming.py` & `zeroconf-0.71.1/src/zeroconf/_protocol/incoming.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_protocol/outgoing.pxd` & `zeroconf-0.71.1/src/zeroconf/_protocol/outgoing.pxd`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_protocol/outgoing.py` & `zeroconf-0.71.1/src/zeroconf/_protocol/outgoing.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_services/__init__.py` & `zeroconf-0.71.1/src/zeroconf/_services/__init__.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_services/browser.py` & `zeroconf-0.71.1/src/zeroconf/_services/browser.py`
...
### Comparing `zeroconf-0.71.0/src/zeroconf/_services/info.py` & `zeroconf-0.71.1/src/zeroconf/_services/info.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_services/registry.py` & `zeroconf-0.71.1/src/zeroconf/_services/registry.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_services/types.py` & `zeroconf-0.71.1/src/zeroconf/_services/types.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_updates.py` & `zeroconf-0.71.1/src/zeroconf/_updates.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_utils/__init__.py` & `zeroconf-0.71.1/src/zeroconf/_utils/__init__.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_utils/asyncio.py` & `zeroconf-0.71.1/src/zeroconf/_utils/asyncio.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_utils/name.py` & `zeroconf-0.71.1/src/zeroconf/_utils/name.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_utils/net.py` & `zeroconf-0.71.1/src/zeroconf/_utils/net.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/_utils/time.py` & `zeroconf-0.71.1/src/zeroconf/_utils/time.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/asyncio.py` & `zeroconf-0.71.1/src/zeroconf/asyncio.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/src/zeroconf/const.py` & `zeroconf-0.71.1/src/zeroconf/const.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/__init__.py` & `zeroconf-0.71.1/tests/__init__.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/conftest.py` & `zeroconf-0.71.1/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/services/__init__.py` & `zeroconf-0.71.1/tests/services/__init__.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/services/test_browser.py` & `zeroconf-0.71.1/tests/services/test_browser.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/services/test_info.py` & `zeroconf-0.71.1/tests/services/test_info.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/services/test_registry.py` & `zeroconf-0.71.1/tests/services/test_registry.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/services/test_types.py` & `zeroconf-0.71.1/tests/services/test_types.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_asyncio.py` & `zeroconf-0.71.1/tests/test_asyncio.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_cache.py` & `zeroconf-0.71.1/tests/test_cache.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_core.py` & `zeroconf-0.71.1/tests/test_core.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_dns.py` & `zeroconf-0.71.1/tests/test_dns.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_exceptions.py` & `zeroconf-0.71.1/tests/test_exceptions.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_handlers.py` & `zeroconf-0.71.1/tests/test_handlers.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_history.py` & `zeroconf-0.71.1/tests/test_history.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_init.py` & `zeroconf-0.71.1/tests/test_init.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_logger.py` & `zeroconf-0.71.1/tests/test_logger.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_protocol.py` & `zeroconf-0.71.1/tests/test_protocol.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_services.py` & `zeroconf-0.71.1/tests/test_services.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/test_updates.py` & `zeroconf-0.71.1/tests/test_updates.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/utils/__init__.py` & `zeroconf-0.71.1/tests/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/utils/test_asyncio.py` & `zeroconf-0.71.1/tests/utils/test_asyncio.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/utils/test_name.py` & `zeroconf-0.71.1/tests/utils/test_name.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/tests/utils/test_net.py` & `zeroconf-0.71.1/tests/utils/test_net.py`

 * *Files identical despite different names*

### Comparing `zeroconf-0.71.0/setup.py` & `zeroconf-0.71.1/setup.py`
...
### Comparing `zeroconf-0.71.0/PKG-INFO` & `zeroconf-0.71.1/PKG-INFO`
