# Comparing `tmp/easyliftover-0.0.2.tar.gz` & `tmp/easyliftover-0.0.3.tar.gz`
...
### Comparing `easyliftover-0.0.2/easyliftover/lifters/abstract.py` & `easyliftover-0.0.3/easyliftover/lifters/abstract.py`
