# Comparing `tmp/resoto-plugin-aws-3.6.2.tar.gz` & `tmp/resoto-plugin-aws-3.6.3.tar.gz`
...
### Comparing `resoto-plugin-aws-3.6.2/resoto_plugin_aws/__init__.py` & `resoto-plugin-aws-3.6.3/resoto_plugin_aws/__init__.py`
