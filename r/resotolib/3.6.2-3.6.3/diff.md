# Comparing `tmp/resotolib-3.6.2.tar.gz` & `tmp/resotolib-3.6.3.tar.gz`
...
### Comparing `resotolib-3.6.2/resotolib/web/static/picnic.min.css` & `resotolib-3.6.3/resotolib/web/static/picnic.min.css`
