# Comparing `tmp/ctgan-0.7.3.dev0.tar.gz` & `tmp/ctgan-0.7.4.dev0.tar.gz`
...
## Comparing `ctgan-0.7.3.dev0.tar` & `ctgan-0.7.4.dev0.tar`
...
### Comparing `ctgan-0.7.3.dev0/CONTRIBUTING.rst` & `ctgan-0.7.4.dev0/CONTRIBUTING.rst`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/HISTORY.md` & `ctgan-0.7.4.dev0/HISTORY.md`
...
### Comparing `ctgan-0.7.3.dev0/LICENSE` & `ctgan-0.7.4.dev0/LICENSE`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/PKG-INFO` & `ctgan-0.7.4.dev0/PKG-INFO`
...
-Intelligence Requires-Python: >=3.7,<3.11 Description-Content-Type: text/
+:: 3.8 Classifier: Programming Language :: Python :: 3.9 Classifier:
+Programming Language :: Python :: 3.10 Classifier: Programming Language ::
+Python :: 3.11 Classifier: Topic :: Scientific/Engineering :: Artificial
+Intelligence Requires-Python: >=3.8,<3.12 Description-Content-Type: text/
...
### Comparing `ctgan-0.7.3.dev0/README.md` & `ctgan-0.7.4.dev0/README.md`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan/__main__.py` & `ctgan-0.7.4.dev0/ctgan/__main__.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan/data.py` & `ctgan-0.7.4.dev0/ctgan/data.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan/data_sampler.py` & `ctgan-0.7.4.dev0/ctgan/data_sampler.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan/data_transformer.py` & `ctgan-0.7.4.dev0/ctgan/data_transformer.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan/synthesizers/base.py` & `ctgan-0.7.4.dev0/ctgan/synthesizers/base.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan/synthesizers/ctgan.py` & `ctgan-0.7.4.dev0/ctgan/synthesizers/ctgan.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan/synthesizers/tvae.py` & `ctgan-0.7.4.dev0/ctgan/synthesizers/tvae.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan.egg-info/PKG-INFO` & `ctgan-0.7.4.dev0/ctgan.egg-info/PKG-INFO`
...
### Comparing `ctgan-0.7.3.dev0/ctgan.egg-info/SOURCES.txt` & `ctgan-0.7.4.dev0/ctgan.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/ctgan.egg-info/requires.txt` & `ctgan-0.7.4.dev0/ctgan.egg-info/requires.txt`
...
### Comparing `ctgan-0.7.3.dev0/setup.cfg` & `ctgan-0.7.4.dev0/setup.cfg`
...
### Comparing `ctgan-0.7.3.dev0/setup.py` & `ctgan-0.7.4.dev0/setup.py`
...
### Comparing `ctgan-0.7.3.dev0/tests/integration/synthesizer/test_ctgan.py` & `ctgan-0.7.4.dev0/tests/integration/synthesizer/test_ctgan.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/tests/integration/synthesizer/test_tvae.py` & `ctgan-0.7.4.dev0/tests/integration/synthesizer/test_tvae.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/tests/integration/test_data_transformer.py` & `ctgan-0.7.4.dev0/tests/integration/test_data_transformer.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/tests/unit/synthesizer/test_base.py` & `ctgan-0.7.4.dev0/tests/unit/synthesizer/test_base.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/tests/unit/synthesizer/test_ctgan.py` & `ctgan-0.7.4.dev0/tests/unit/synthesizer/test_ctgan.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/tests/unit/synthesizer/test_tvae.py` & `ctgan-0.7.4.dev0/tests/unit/synthesizer/test_tvae.py`

 * *Files identical despite different names*

### Comparing `ctgan-0.7.3.dev0/tests/unit/test_data_transformer.py` & `ctgan-0.7.4.dev0/tests/unit/test_data_transformer.py`
