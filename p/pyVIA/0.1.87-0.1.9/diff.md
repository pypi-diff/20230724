# Comparing `tmp/pyVIA-0.1.87.tar.gz` & `tmp/pyVIA-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyVIA-0.1.87.tar", last modified: Mon Jul 24 04:57:05 2023, max compression
+gzip compressed data, was "dist/pyVIA-0.1.9.tar", last modified: Tue Jan 19 04:52:20 2021, max compression
```

## Comparing `pyVIA-0.1.87.tar` & `pyVIA-0.1.9.tar`

### file list

```diff
@@ -1,20 +1,14 @@
-drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-24 04:57:05.382653 pyVIA-0.1.87/
--rwxr-xr-x   0 user      (1000) user      (1000)     1091 2020-09-15 01:01:11.000000 pyVIA-0.1.87/LICENSE.txt
--rw-rw-r--   0 user      (1000) user      (1000)    19655 2023-07-24 04:57:05.382653 pyVIA-0.1.87/PKG-INFO
--rwxr-xr-x   0 user      (1000) user      (1000)    19436 2021-04-06 00:42:30.000000 pyVIA-0.1.87/README.md
-drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-24 04:57:05.378653 pyVIA-0.1.87/pyVIA/
--rwxr-xr-x   0 user      (1000) user      (1000)      143 2022-08-25 21:48:14.000000 pyVIA-0.1.87/pyVIA/__init__.py
--rwxr-xr-x   0 user      (1000) user      (1000)   181848 2023-07-24 04:55:51.000000 pyVIA-0.1.87/pyVIA/core.py
--rwxr-xr-x   0 user      (1000) user      (1000)     9598 2022-12-11 20:55:33.000000 pyVIA-0.1.87/pyVIA/datasets_via.py
--rwxr-xr-x   0 user      (1000) user      (1000)   160718 2023-02-22 01:50:18.000000 pyVIA-0.1.87/pyVIA/examples.py
--rwxr-xr-x   0 user      (1000) user      (1000)   161409 2023-07-17 03:35:01.000000 pyVIA-0.1.87/pyVIA/plotting_via.py
--rwxr-xr-x   0 user      (1000) user      (1000)    76027 2023-07-16 14:02:05.000000 pyVIA-0.1.87/pyVIA/utils_via.py
--rwxr-xr-x   0 user      (1000) user      (1000)     7987 2022-03-15 20:16:24.000000 pyVIA-0.1.87/pyVIA/windmap.py
-drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-24 04:57:05.382653 pyVIA-0.1.87/pyVIA.egg-info/
--rw-rw-r--   0 user      (1000) user      (1000)    19655 2023-07-24 04:57:05.000000 pyVIA-0.1.87/pyVIA.egg-info/PKG-INFO
--rw-rw-r--   0 user      (1000) user      (1000)      304 2023-07-24 04:57:05.000000 pyVIA-0.1.87/pyVIA.egg-info/SOURCES.txt
--rw-rw-r--   0 user      (1000) user      (1000)        1 2023-07-24 04:57:05.000000 pyVIA-0.1.87/pyVIA.egg-info/dependency_links.txt
--rw-rw-r--   0 user      (1000) user      (1000)      193 2023-07-24 04:57:05.000000 pyVIA-0.1.87/pyVIA.egg-info/requires.txt
--rw-rw-r--   0 user      (1000) user      (1000)        6 2023-07-24 04:57:05.000000 pyVIA-0.1.87/pyVIA.egg-info/top_level.txt
--rw-rw-r--   0 user      (1000) user      (1000)       38 2023-07-24 04:57:05.382653 pyVIA-0.1.87/setup.cfg
--rwxr-xr-x   0 user      (1000) user      (1000)      916 2023-07-24 04:56:14.000000 pyVIA-0.1.87/setup.py
...
### Comparing `pyVIA-0.1.87/PKG-INFO` & `pyVIA-0.1.9/README.md`
...
### Comparing `pyVIA-0.1.87/setup.py` & `pyVIA-0.1.9/setup.py`
...
@@ -5,17 +5,17 @@
 ...
 setuptools.setup(
     name='pyVIA',
-    version='0.1.87', ##July 24 2023 # May-2-2023
