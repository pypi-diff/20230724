# Comparing `tmp/netket-3.9.tar.gz` & `tmp/netket-3.9.1.tar.gz`
...
### Comparing `netket-3.9/netket/experimental/vqs/__init__.py` & `netket-3.9.1/netket/experimental/vqs/__init__.py`
...
### Comparing `netket-3.9/netket/models/__init__.py` & `netket-3.9.1/netket/models/__init__.py`
...
### Comparing `netket-3.9/netket/models/jastrow.py` & `netket-3.9.1/netket/models/jastrow.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/models/mlp.py` & `netket-3.9.1/netket/models/mlp.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/models/mps.py` & `netket-3.9.1/netket/models/mps.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/models/ndm.py` & `netket-3.9.1/netket/models/ndm.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/models/rbm.py` & `netket-3.9.1/netket/models/rbm.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/models/utils.py` & `netket-3.9.1/netket/models/utils.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/__init__.py` & `netket-3.9.1/netket/nn/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/activation.py` & `netket-3.9.1/netket/nn/activation.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/deprecation.py` & `netket-3.9.1/netket/nn/deprecation.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/fast_masked_linear.py` & `netket-3.9.1/netket/nn/fast_masked_linear.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/initializers.py` & `netket-3.9.1/netket/nn/initializers.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/masked_linear.py` & `netket-3.9.1/netket/nn/masked_linear.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/symmetric_linear.py` & `netket-3.9.1/netket/nn/symmetric_linear.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/utils.py` & `netket-3.9.1/netket/nn/utils.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/blocks/__init__.py` & `netket-3.9.1/netket/nn/blocks/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/blocks/deepset.py` & `netket-3.9.1/netket/nn/blocks/deepset.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/blocks/mlp.py` & `netket-3.9.1/netket/nn/blocks/mlp.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/nn/blocks/symmetry_sum.py` & `netket-3.9.1/netket/nn/blocks/symmetry_sum.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/__init__.py` & `netket-3.9.1/netket/operator/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_abstract_operator.py` & `netket-3.9.1/netket/operator/_abstract_operator.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_abstract_super_operator.py` & `netket-3.9.1/netket/operator/_abstract_super_operator.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_bose_hubbard.py` & `netket-3.9.1/netket/operator/_bose_hubbard.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_continuous_operator.py` & `netket-3.9.1/netket/operator/_continuous_operator.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_discrete_operator.py` & `netket-3.9.1/netket/operator/_discrete_operator.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_discrete_operator_jax.py` & `netket-3.9.1/netket/operator/_discrete_operator_jax.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_graph_operator.py` & `netket-3.9.1/netket/operator/_graph_operator.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_hamiltonian.py` & `netket-3.9.1/netket/operator/_hamiltonian.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_heisenberg.py` & `netket-3.9.1/netket/operator/_heisenberg.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_kinetic.py` & `netket-3.9.1/netket/operator/_kinetic.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_lazy.py` & `netket-3.9.1/netket/operator/_lazy.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_local_liouvillian.py` & `netket-3.9.1/netket/operator/_local_liouvillian.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_potential.py` & `netket-3.9.1/netket/operator/_potential.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_sumoperators.py` & `netket-3.9.1/netket/operator/_sumoperators.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/boson.py` & `netket-3.9.1/netket/operator/boson.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/spin.py` & `netket-3.9.1/netket/operator/spin.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_ising/__init__.py` & `netket-3.9.1/netket/operator/_ising/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_ising/base.py` & `netket-3.9.1/netket/operator/_ising/base.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_ising/jax.py` & `netket-3.9.1/netket/operator/_ising/jax.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_ising/numba.py` & `netket-3.9.1/netket/operator/_ising/numba.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_local_operator/__init__.py` & `netket-3.9.1/netket/operator/_local_operator/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_local_operator/base.py` & `netket-3.9.1/netket/operator/_local_operator/base.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_local_operator/compile_helpers.py` & `netket-3.9.1/netket/operator/_local_operator/compile_helpers.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_local_operator/convert.py` & `netket-3.9.1/netket/operator/_local_operator/convert.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_local_operator/helpers.py` & `netket-3.9.1/netket/operator/_local_operator/helpers.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_pauli_strings/__init__.py` & `netket-3.9.1/netket/operator/_pauli_strings/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_pauli_strings/base.py` & `netket-3.9.1/netket/operator/_pauli_strings/base.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/operator/_pauli_strings/jax.py` & `netket-3.9.1/netket/operator/_pauli_strings/jax.py`
...
### Comparing `netket-3.9/netket/operator/_pauli_strings/numba.py` & `netket-3.9.1/netket/operator/_pauli_strings/numba.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/__init__.py` & `netket-3.9.1/netket/optimizer/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/linear_operator.py` & `netket-3.9.1/netket/optimizer/linear_operator.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/preconditioner.py` & `netket-3.9.1/netket/optimizer/preconditioner.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/sr.py` & `netket-3.9.1/netket/optimizer/sr.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/__init__.py` & `netket-3.9.1/netket/optimizer/qgt/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/common.py` & `netket-3.9.1/netket/optimizer/qgt/common.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/default.py` & `netket-3.9.1/netket/optimizer/qgt/default.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/qgt_jacobian_common.py` & `netket-3.9.1/netket/optimizer/qgt/qgt_jacobian_common.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/qgt_jacobian_dense.py` & `netket-3.9.1/netket/optimizer/qgt/qgt_jacobian_dense.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/qgt_jacobian_pytree.py` & `netket-3.9.1/netket/optimizer/qgt/qgt_jacobian_pytree.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/qgt_jacobian_pytree_logic.py` & `netket-3.9.1/netket/optimizer/qgt/qgt_jacobian_pytree_logic.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/qgt_onthefly.py` & `netket-3.9.1/netket/optimizer/qgt/qgt_onthefly.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/qgt/qgt_onthefly_logic.py` & `netket-3.9.1/netket/optimizer/qgt/qgt_onthefly_logic.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/optimizer/solver/solvers.py` & `netket-3.9.1/netket/optimizer/solver/solvers.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/__init__.py` & `netket-3.9.1/netket/sampler/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/autoreg.py` & `netket-3.9.1/netket/sampler/autoreg.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/base.py` & `netket-3.9.1/netket/sampler/base.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/exact.py` & `netket-3.9.1/netket/sampler/exact.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/metropolis.py` & `netket-3.9.1/netket/sampler/metropolis.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/metropolis_numpy.py` & `netket-3.9.1/netket/sampler/metropolis_numpy.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/__init__.py` & `netket-3.9.1/netket/sampler/rules/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/base.py` & `netket-3.9.1/netket/sampler/rules/base.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/continuous_gaussian.py` & `netket-3.9.1/netket/sampler/rules/continuous_gaussian.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/custom_numpy.py` & `netket-3.9.1/netket/sampler/rules/custom_numpy.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/exchange.py` & `netket-3.9.1/netket/sampler/rules/exchange.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/fixed.py` & `netket-3.9.1/netket/sampler/rules/fixed.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/hamiltonian.py` & `netket-3.9.1/netket/sampler/rules/hamiltonian.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/hamiltonian_numpy.py` & `netket-3.9.1/netket/sampler/rules/hamiltonian_numpy.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/langevin.py` & `netket-3.9.1/netket/sampler/rules/langevin.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/local.py` & `netket-3.9.1/netket/sampler/rules/local.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/local_numpy.py` & `netket-3.9.1/netket/sampler/rules/local_numpy.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/multiple.py` & `netket-3.9.1/netket/sampler/rules/multiple.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/sampler/rules/tensor.py` & `netket-3.9.1/netket/sampler/rules/tensor.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/stats/__init__.py` & `netket-3.9.1/netket/stats/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/stats/_autocorr.py` & `netket-3.9.1/netket/stats/_autocorr.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/stats/mc_stats.py` & `netket-3.9.1/netket/stats/mc_stats.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/stats/mc_stats_old.py` & `netket-3.9.1/netket/stats/mc_stats_old.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/stats/mpi_stats.py` & `netket-3.9.1/netket/stats/mpi_stats.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/tools/_common.py` & `netket-3.9.1/netket/tools/_common.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/tools/_cpu_info.py` & `netket-3.9.1/netket/tools/_cpu_info.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/tools/_mpi_info.py` & `netket-3.9.1/netket/tools/_mpi_info.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/tools/check_mpi.py` & `netket-3.9.1/netket/tools/check_mpi.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/tools/info.py` & `netket-3.9.1/netket/tools/info.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/__init__.py` & `netket-3.9.1/netket/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/_dependencies_check.py` & `netket-3.9.1/netket/utils/_dependencies_check.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/array.py` & `netket-3.9.1/netket/utils/array.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/config_flags.py` & `netket-3.9.1/netket/utils/config_flags.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/deprecation.py` & `netket-3.9.1/netket/utils/deprecation.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/dispatch.py` & `netket-3.9.1/netket/utils/dispatch.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/float.py` & `netket-3.9.1/netket/utils/float.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/history.py` & `netket-3.9.1/netket/utils/history.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/holomorphic.py` & `netket-3.9.1/netket/utils/holomorphic.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/jax.py` & `netket-3.9.1/netket/utils/jax.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/moduletools.py` & `netket-3.9.1/netket/utils/moduletools.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/numbers.py` & `netket-3.9.1/netket/utils/numbers.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/optional_deps.py` & `netket-3.9.1/netket/utils/optional_deps.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/partial.py` & `netket-3.9.1/netket/utils/partial.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/seed.py` & `netket-3.9.1/netket/utils/seed.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/static_number.py` & `netket-3.9.1/netket/utils/static_number.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/summation.py` & `netket-3.9.1/netket/utils/summation.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/types.py` & `netket-3.9.1/netket/utils/types.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/version_check.py` & `netket-3.9.1/netket/utils/version_check.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/__init__.py` & `netket-3.9.1/netket/utils/group/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/_group.py` & `netket-3.9.1/netket/utils/group/_group.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/_permutation_group.py` & `netket-3.9.1/netket/utils/group/_permutation_group.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/_point_group.py` & `netket-3.9.1/netket/utils/group/_point_group.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/_semigroup.py` & `netket-3.9.1/netket/utils/group/_semigroup.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/axial.py` & `netket-3.9.1/netket/utils/group/axial.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/cubic.py` & `netket-3.9.1/netket/utils/group/cubic.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/icosa.py` & `netket-3.9.1/netket/utils/group/icosa.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/group/planar.py` & `netket-3.9.1/netket/utils/group/planar.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/model_frameworks/__init__.py` & `netket-3.9.1/netket/utils/model_frameworks/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/model_frameworks/base.py` & `netket-3.9.1/netket/utils/model_frameworks/base.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/model_frameworks/flax.py` & `netket-3.9.1/netket/utils/model_frameworks/flax.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/model_frameworks/haiku.py` & `netket-3.9.1/netket/utils/model_frameworks/haiku.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/model_frameworks/jax.py` & `netket-3.9.1/netket/utils/model_frameworks/jax.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/mpi/__init__.py` & `netket-3.9.1/netket/utils/mpi/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/mpi/mpi.py` & `netket-3.9.1/netket/utils/mpi/mpi.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/mpi/primitives.py` & `netket-3.9.1/netket/utils/mpi/primitives.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/struct/__init__.py` & `netket-3.9.1/netket/utils/struct/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/struct/dataclass.py` & `netket-3.9.1/netket/utils/struct/dataclass.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/utils/struct/utils.py` & `netket-3.9.1/netket/utils/struct/utils.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/__init__.py` & `netket-3.9.1/netket/vqs/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/base.py` & `netket-3.9.1/netket/vqs/base.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/experimental.py` & `netket-3.9.1/netket/vqs/experimental.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/full_summ/__init__.py` & `netket-3.9.1/netket/vqs/full_summ/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/full_summ/expect.py` & `netket-3.9.1/netket/vqs/full_summ/expect.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/full_summ/state.py` & `netket-3.9.1/netket/vqs/full_summ/state.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/__init__.py` & `netket-3.9.1/netket/vqs/mc/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/common.py` & `netket-3.9.1/netket/vqs/mc/common.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/kernels.py` & `netket-3.9.1/netket/vqs/mc/kernels.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_mixed_state/__init__.py` & `netket-3.9.1/netket/vqs/mc/mc_mixed_state/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_mixed_state/expect.py` & `netket-3.9.1/netket/vqs/mc/mc_mixed_state/expect.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_mixed_state/expect_chunked.py` & `netket-3.9.1/netket/vqs/mc/mc_mixed_state/expect_chunked.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_mixed_state/expect_grad_chunked.py` & `netket-3.9.1/netket/vqs/mc/mc_mixed_state/expect_grad_chunked.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_mixed_state/state.py` & `netket-3.9.1/netket/vqs/mc/mc_mixed_state/state.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/__init__.py` & `netket-3.9.1/netket/vqs/mc/mc_state/__init__.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/expect.py` & `netket-3.9.1/netket/vqs/mc/mc_state/expect.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/expect_chunked.py` & `netket-3.9.1/netket/vqs/mc/mc_state/expect_chunked.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/expect_forces.py` & `netket-3.9.1/netket/vqs/mc/mc_state/expect_forces.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/expect_forces_chunked.py` & `netket-3.9.1/netket/vqs/mc/mc_state/expect_forces_chunked.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/expect_grad.py` & `netket-3.9.1/netket/vqs/mc/mc_state/expect_grad.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/expect_grad_chunked.py` & `netket-3.9.1/netket/vqs/mc/mc_state/expect_grad_chunked.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/netket/vqs/mc/mc_state/state.py` & `netket-3.9.1/netket/vqs/mc/mc_state/state.py`

 * *Files identical despite different names*

### Comparing `netket-3.9/.gitignore` & `netket-3.9.1/.gitignore`

 * *Files identical despite different names*

### Comparing `netket-3.9/LICENSE` & `netket-3.9.1/LICENSE`

 * *Files identical despite different names*

### Comparing `netket-3.9/README.md` & `netket-3.9.1/README.md`

 * *Files identical despite different names*

### Comparing `netket-3.9/pyproject.toml` & `netket-3.9.1/pyproject.toml`

 * *Files identical despite different names*

### Comparing `netket-3.9/PKG-INFO` & `netket-3.9.1/PKG-INFO`
