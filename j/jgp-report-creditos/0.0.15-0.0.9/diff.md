# Comparing `tmp/jgp_report_creditos-0.0.15.tar.gz` & `tmp/jgp_report_creditos-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jgp_report_creditos-0.0.15.tar", last modified: Mon Jul 24 02:32:38 2023, max compression
+gzip compressed data, was "jgp_report_creditos-0.0.9.tar", last modified: Mon Jun  5 16:17:06 2023, max compression
```

## Comparing `jgp_report_creditos-0.0.15.tar` & `jgp_report_creditos-0.0.9.tar`

### file list

```diff
@@ -1,40 +1,25 @@
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.133971 jgp_report_creditos-0.0.15/
--rw-rw-rw-   0        0        0     1074 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/LICENSE
--rw-rw-rw-   0        0        0     6723 2023-07-24 02:32:38.132974 jgp_report_creditos-0.0.15/PKG-INFO
--rw-rw-rw-   0        0        0     6246 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/README.md
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.112031 jgp_report_creditos-0.0.15/jgp_report_creditos/
--rw-rw-rw-   0        0        0       83 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/__init__.py
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.120008 jgp_report_creditos-0.0.15/jgp_report_creditos/core/
--rw-rw-rw-   0        0        0       56 2023-06-19 20:47:24.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/__init__.py
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.121005 jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/
--rw-rw-rw-   0        0        0        0 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/__init__.py
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.123998 jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/v1/
--rw-rw-rw-   0        0        0     4711 2023-06-16 14:55:12.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/v1/Controlar tablas de firmas.py
--rw-rw-rw-   0        0        0        0 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/v1/__init__.py
--rw-rw-rw-   0        0        0   149790 2023-07-24 02:29:13.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/v1/base.py
--rw-rw-rw-   0        0        0    20075 2023-07-21 17:51:24.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/v1/contratos.py
--rw-rw-rw-   0        0        0    36814 2023-07-18 15:54:08.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/deposito.py
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.125993 jgp_report_creditos-0.0.15/jgp_report_creditos/core/exception/
--rw-rw-rw-   0        0        0       37 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/exception/__init__.py
--rw-rw-rw-   0        0        0      309 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/exception/exception.py
--rw-rw-rw-   0        0        0     5160 2023-07-19 18:01:32.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/core/rutas.py
--rw-rw-rw-   0        0        0    22495 2023-07-20 13:31:18.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/report.py
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.106055 jgp_report_creditos-0.0.15/jgp_report_creditos/resources/
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.126990 jgp_report_creditos-0.0.15/jgp_report_creditos/resources/img/
--rw-rw-rw-   0        0        0    57446 2023-06-15 20:54:52.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/resources/img/logo_jgp.png
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.129982 jgp_report_creditos-0.0.15/jgp_report_creditos/template/
--rw-rw-rw-   0        0        0        0 2023-06-17 16:56:44.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/template/__init__.py
--rw-rw-rw-   0        0        0    22964 2023-07-12 19:53:26.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/template/components.py
--rw-rw-rw-   0        0        0      660 2023-06-17 16:08:06.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/template/template.py
--rw-rw-rw-   0        0        0      714 2023-06-15 21:23:54.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/test.py
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.131976 jgp_report_creditos-0.0.15/jgp_report_creditos/tests/
--rw-rw-rw-   0        0        0        0 2023-06-17 16:57:48.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/tests/__init__.py
--rw-rw-rw-   0        0        0     1041 2023-07-24 02:31:02.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/tests/test_contratos.py
--rw-rw-rw-   0        0        0    33385 2023-07-22 14:28:40.000000 jgp_report_creditos-0.0.15/jgp_report_creditos/tests/test_deposito.py
-drwxrwxrwx   0        0        0        0 2023-07-24 02:32:38.118014 jgp_report_creditos-0.0.15/jgp_report_creditos.egg-info/
--rw-rw-rw-   0        0        0     6723 2023-07-24 02:32:38.000000 jgp_report_creditos-0.0.15/jgp_report_creditos.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0     1045 2023-07-24 02:32:38.000000 jgp_report_creditos-0.0.15/jgp_report_creditos.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-07-24 02:32:38.000000 jgp_report_creditos-0.0.15/jgp_report_creditos.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       20 2023-07-24 02:32:38.000000 jgp_report_creditos-0.0.15/jgp_report_creditos.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-07-24 02:32:38.133971 jgp_report_creditos-0.0.15/setup.cfg
--rw-rw-rw-   0        0        0      975 2023-07-24 02:13:03.000000 jgp_report_creditos-0.0.15/setup.py
...
### Comparing `jgp_report_creditos-0.0.15/PKG-INFO` & `jgp_report_creditos-0.0.9/PKG-INFO`
...
### Comparing `jgp_report_creditos-0.0.15/README.md` & `jgp_report_creditos-0.0.9/README.md`

 * *Files identical despite different names*

### Comparing `jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/v1/base.py` & `jgp_report_creditos-0.0.9/jgp_report_creditos/core/contrato/v1/base.py`
...
-        # Otros Doc. En Custodia
-
-        if(((len(deudores)+len(fiadores))==2 and tipo_garantia=="Prendaria y Personal") or (tipo_garantia=="Personal y  Doc. custodia Vehiculo" and (len(deudores)+len(fiadores))==2)or (tipo_garantia=="Convenio y Garantia personal" and (len(deudores)+len(fiadores))==4)):
-                self._parrafos.append(Spacer(0,4))
...
### Comparing `jgp_report_creditos-0.0.15/jgp_report_creditos/core/contrato/v1/contratos.py` & `jgp_report_creditos-0.0.9/jgp_report_creditos/core/contrato/v1/contratos.py`
...
### Comparing `jgp_report_creditos-0.0.15/jgp_report_creditos/test.py` & `jgp_report_creditos-0.0.9/jgp_report_creditos/test.py`
...
### Comparing `jgp_report_creditos-0.0.15/jgp_report_creditos.egg-info/PKG-INFO` & `jgp_report_creditos-0.0.9/jgp_report_creditos.egg-info/PKG-INFO`
...
### Comparing `jgp_report_creditos-0.0.15/jgp_report_creditos.egg-info/SOURCES.txt` & `jgp_report_creditos-0.0.9/jgp_report_creditos.egg-info/SOURCES.txt`
...
### Comparing `jgp_report_creditos-0.0.15/setup.py` & `jgp_report_creditos-0.0.9/setup.py`
